...
setTip(edF0,"Lower frequency of the sweep (FM) or carrier (CF). If f0 > f1, values are swapped.");
rc = rc + 1;
...
setTip(edF1,"Upper frequency of FM sweep (ignored for CF except for convenience).");
rc = rc + 1;
...
%% ==================== Callbacks ====================
    ...
    function showAbout()
        ...
        html = strjoin([ ...
            ...
            "<div>Version: 1.0</div>", ...
            "<div>Initial release: 05 February 2026</div>", ...
            ...
            ...
            " ", ...
            "2. Umadi (2026), <b>WAH-<i>i</i> : Optimising Array Geometry for Customised Localisation Accuracy</b><br>", ...
            " ", ...
